report 70110 "Standard Sales - Invoice CLONE"
{
    Caption = 'Sales - Invoice CLONE';
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/reports/05 Document/StandardSalesInvoice.rdlc';
        ...
        {
            Type = Word;
            LayoutFile = './src/reports/05 Document/StandardSalesInvoice.docx';
