table 90121 "PBI Dataflow Refresh History"
{
    ...
    fields
    {
        ...
        field(10; "Dataflow ID"; Text[250])
        {
            Caption = 'Dataflow ID';
            DataClassification = CustomerContent;
        }

        field(11; "Dataflow Name"; Text[250])
        {
        ...
        field(20; "Transaction ID"; Text[250])
        {
    ...
    keys
    {
        ...
        key(Dataflow; "Dataflow ID", "Start Time")
        {
        }
